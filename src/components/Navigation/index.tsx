...
const Navigation: React.FC<NavigationProps> = () => {
  ...
  return (
    <div className="navbar bg-base-200 w-full rounded-lg shadow mb-4 max-md:mb-2 max-md:p-0 p-4 sticky top-0 z-50">
        ...
        <div className="hidden min-[816px]:block">
          <ul className="menu menu-horizontal">
            {menus.map((menu: any, index: number) => (
              <Button key={index} className="btn btn-lg btn-ghost text-lg">
                {menu}
              </Button>
            ))}
          </ul>
